#!/usr/bin/env node
/**
 * R100 DEX Production Freeze — full route screenshot matrix.
...
const OUT = path.resolve(__dirname, '../../../docs/screenshots/r100-dex-production-freeze')
...
async function main() {
  ...
  fs.writeFileSync(
    ...
    JSON.stringify(
      {
        task: 'R100 DEX PRODUCTION FREEZE',

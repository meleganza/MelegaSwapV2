#!/usr/bin/env node
/**
 * R011 Build Studio Economic Infrastructure Foundation screenshots.
 */
...
const OUT = path.resolve(__dirname, '../../../docs/screenshots/r011-build-studio-economic-infrastructure-foundation')
...
async function main() {
  ...
  for (const shot of SHOTS) {
    ...
    await page.waitForSelector('[data-bs-main-grid]', { timeout: 120000 }).catch(() => undefined)
    await page.waitForSelector('[data-bs-kpi-row]', { timeout: 120000 }).catch(() => undefined)

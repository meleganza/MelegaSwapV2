#!/usr/bin/env node
/**
 * R005-A Farms page foundation screenshots — requires server on BASE_URL.
 */
...
const OUT = path.resolve(__dirname, '../../../docs/screenshots/r005a-farms-page-foundation')
...
async function main() {
  ...
  fs.writeFileSync(
    ...
    JSON.stringify(
      {
        task: 'R005-A FARMS PAGE FOUNDATION',

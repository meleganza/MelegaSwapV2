#!/usr/bin/env node
/**
 * R004-C final pixel fit screenshots — requires server on BASE_URL.
 */
...
const OUT = path.resolve(__dirname, '../../../docs/screenshots/r004c-final-pixel-fit')

...
export const LB_UX = {
  ...
  tokenToGrowLabel: 'Project token',
  tokenToGrowSupport: 'Search by name or paste the token contract.',
  ...
  quoteAssetLabel: 'Pair with',
  quoteAssetSupport: 'The asset paired with your token. BNB is recommended for the simplest setup.',
  reserveLabel: 'Token Reserve',
  reserveSupport: 'Maximum amount of your token that the program can use to build liquidity.',
  reserveExample: 'Enter token amount',
  ...
  docsHub: '/docs/liquidity-builder',
  docsOverview: '/docs/liquidity-builder/overview',
  docsHowItWorks: '/docs/liquidity-builder/how-it-works',
  ...
  docsRiskSafety: '/docs/liquidity-builder/risk-safety',
  docsExamples: '/docs/liquidity-builder/examples',
  docsFieldLink: 'Docs',

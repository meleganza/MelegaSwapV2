...
export const LB_UX = {
  ...
  aiBadge: 'AI Powered',
  /** LB024 product entry — distinct from manual Add Liquidity */
  entryTitle: 'Build lasting liquidity automatically',
  entryLead:
    'Dedicate part of your token reserve. Melega automatically converts eligible market activity into protocol-owned liquidity while you retain ownership of the resulting LP position.',
  entrySupport:
    'Dedicate a token reserve and let Melega progressively build liquidity from eligible market activity.',
  startCta: 'Set Up Liquidity Building',
  openDashboardCta: 'Open Dashboard',
  viewActivationCta: 'View Activation Status',
  ...
  emptyNoProgram: 'No liquidity executions yet.',
  pairNotDetected: 'No Melega pool detected for this token and quote.',
  pairDetected: 'Melega pool detected',
  pairLoading: 'Detecting Melega pool…',
  programUnavailable: 'Program data unavailable until Liquidity Building contracts are deployed.',

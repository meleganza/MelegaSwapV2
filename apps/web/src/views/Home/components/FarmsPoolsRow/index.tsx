  ...
  return (
    <div ref={observerRef}>
      <Flex flexDirection="column" mt="24px">
        <Flex mb="24px">
          <RowHeading text={showFarms ? t('Top Farms') : t('Top MARCO Pools')} />
          <IconButton
            variant="text"
            height="100%"
            width="auto"
        ...
        <Box height={['240px', null, '80px']}>
          <Grid>
            {topFarms.map((topFarm, index) => (
              <TopFarmPool
                key={index}
                title={topFarm?.lpSymbol} // FIXME: Property 'lpSymbol' does not exist on type 'FarmWithStakedValue'

...
export const PROJECT_PREVIEW_CARDS: ProjectPreviewCard[] = [
  {
    ...
    metrics: [
      ...
      { label: 'Volume', value: '$1.28M', tone: 'green' },
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: 'Volume', value: '$180K', tone: 'gold' },
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: 'Volume', value: '$92K', tone: 'gold' },
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: 'Volume', value: '$48K', tone: 'gold' },
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: 'Volume', value: '$64K', tone: 'gold' },

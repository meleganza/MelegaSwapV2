...
import { CsOutlineBtn } from './collectiblesStudioPrimitives'
...
export const IdentityPageHeader: React.FC = () => (
  <Hero data-cs-page-header data-r400-identity-hero>
    <Left>
      <CivilizationRoleLabel module="collectibles" />
      <Title>IDENTITY HUB</Title>
      <Subtitle>
        Civilization identities across Melega DEX.
        <br />
        The chain is the implementation.
        <br />
        Identity is the product.
      </Subtitle>
      <BtnRow>
        <CsOutlineBtn type="button" as="a" href="#your-identity" data-cs-hero-identity>
          Your Identity
        </CsOutlineBtn>
        <CsOutlineBtn type="button" as="a" href="#identity-collections" data-cs-hero-collections>
...
export default IdentityPageHeader

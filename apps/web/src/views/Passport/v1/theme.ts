...
export const Stack = styled.div`
  ...
  /* Desktop DOM order = product order. Mobile elevates claimables above positions. */
  @media (max-width: 767px) {
    [data-passport-section='hero'] {
      order: 1;
    }
    [data-passport-section='portfolio'] {
      order: 2;
    }
    [data-passport-section='claimables'] {
      order: 3;
    }
    [data-passport-section='positions'] {
      order: 4;
    }
    [data-passport-section='projects'] {
      order: 5;
    }
    [data-passport-section='benefits'] {
      order: 6;
    }
    [data-passport-section='account'] {
      order: 7;
    }
  }
`

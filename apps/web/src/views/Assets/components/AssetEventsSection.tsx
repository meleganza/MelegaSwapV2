...
import { getEventsByAssetSlug } from 'registry/events/getEventBySlug'
...
interface AssetEventsSectionProps {
  assetSlug: string
}

const AssetEventsSection: React.FC<AssetEventsSectionProps> = ({ assetSlug }) => {
  const { t } = useTranslation()
  const events = getEventsByAssetSlug(assetSlug)
...
export default AssetEventsSection

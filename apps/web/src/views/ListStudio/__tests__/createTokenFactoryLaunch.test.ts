...
describe('MELEGA_DEX_V1_CREATE_TOKEN_FACTORY_AND_LAUNCH_SYSTEM', () => {
  it('keeps canonical factory binding null (no fabricated mainnet address)', () => {
    ...
    expect(CREATE_TOKEN_CANONICAL_DEPLOYMENT.creationFeeWei).toBeNull()
    expect(CREATE_TOKEN_CANONICAL_DEPLOYMENT.creationFeeDecision).toBe('PENDING_FOUNDER_APPROVAL')
  ...
  it('exposes machine-readable readiness API shape', () => {
    ...
    expect(body.creationFeeConfigured).toBe(false)

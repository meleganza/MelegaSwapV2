...
export const getCakeVaultEarnings = (
  ...
  const hasAutoEarnings = account && dexTokenAtLastUserAction?.gt(0) && userShares?.gt(0)
  const { cakeAsBigNumber } = convertSharesToCake(userShares, pricePerFullShare)
  const autoCakeProfit = cakeAsBigNumber.minus(fee || BIG_ZERO).minus(dexTokenAtLastUserAction)

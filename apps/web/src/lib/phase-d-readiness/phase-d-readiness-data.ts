...
export const PHASE_D_ROUTES: PhaseDRouteRecord[] = [
  ...
  { route: '/command-center', pagePath: 'src/pages/workspace/index.tsx', phase: 'shared', verified: true },
  { route: '/build-studio#build-import', pagePath: 'src/pages/launch/index.tsx', phase: 'shared', verified: true },
  { route: '/trade', pagePath: 'src/pages/swap/index.tsx', phase: 'legacy_dex', verified: true },
  { route: '/liquidity-studio', pagePath: 'src/pages/liquidity.tsx', phase: 'legacy_dex', verified: true },

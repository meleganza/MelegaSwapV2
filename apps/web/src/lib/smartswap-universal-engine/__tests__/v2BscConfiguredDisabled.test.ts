...
describe('MELEGA-SMARTSWAP-V2-BSC-CONFIGURED-DISABLED', () => {
  it('1: stored BSC row is CONFIGURED / enabled=false / canonical executor', () => {
  ...
  it('3/4: resolve(56) is non-executable; runtime enabled is false', () => {
    ...
    expect(isV2ExecutorRuntimeEnabled(resolved)).toBe(false)
    expect(isV2ExecutorRuntimeEnabled(V2_EXECUTION_RUNTIME_CONFIG[56])).toBe(false)
  })
  ...
  it('6/7: public CTA stays LEGACY; V2 submit is not reachable', async () => {

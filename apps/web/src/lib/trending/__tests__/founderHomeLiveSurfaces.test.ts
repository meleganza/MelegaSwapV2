...
describe('Founder Home live-surface contracts', () => {
  it('uses a request-time market authority and a short honest outage bridge for Top Movers', () => {
    ...
    expect(durable).toContain('15 * 60 * 1000')

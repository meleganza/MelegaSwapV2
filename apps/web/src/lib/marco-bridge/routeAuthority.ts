...
export function assertCanonicalRouteAuthority(payload: unknown): CanonicalMmnRouteState {
  ...
  // Canonical BNB↔Base publicly_active / execution_enabled is accepted MMN truth.
  // Melega local execution of Base stays gated by MARCO_BRIDGE_ACTIVATION_ROUTES.

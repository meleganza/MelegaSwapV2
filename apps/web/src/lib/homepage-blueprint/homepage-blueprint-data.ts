...
export const HOMEPAGE_JOURNEYS = [
  {
    ...
    steps: [
      ...
      { label: 'Swap if ready', route: '/swap', priority: 'core' as const },
      { label: 'Explore Workspace', route: '/workspace', priority: 'core' as const },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { label: 'Route execution to swap', route: '/swap', priority: 'core' as const },
    ],
  ...
  },
  {
    ...
    entryRoute: '/',
    steps: [
      { label: 'Launch capabilities', route: '/launch', priority: 'core' as const },
      ...
      { label: 'Workspace', route: '/workspace', priority: 'core' as const },
    ],
  ...
  },
  {
    ...
    entryRoute: '/',
    steps: [
      { label: 'Swap or Liquidity', route: '/swap', priority: 'core' as const },
      { label: 'Farms/Pools via Earn', route: '/farms', priority: 'core' as const },
      { label: 'Workspace venues', route: '/workspace', priority: 'core' as const },
    ],

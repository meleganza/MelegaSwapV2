...
export const WRAPPER_EXECUTION_SEQUENCE = [
  ...
  '6. Wrapper approves execution adapter for netAmountIn only',
  '7. Wrapper calls IExecutionAdapter (resolved to V2 or Smart Router implementation)',
...
export const FUTURE_EXECUTION_PIPELINE = [
  ...
  'Treasury Collector',
  'Underlying execution adapter (V2 or Smart Router)',
  'Swap execution',
  'Receipt',
  'Treasury Runtime',
  'FSC-01 settlement',

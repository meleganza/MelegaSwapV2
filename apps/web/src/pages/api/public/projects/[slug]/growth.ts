...
import { loadProjectGrowthDocument, normalizeProjectSlugInput } from 'registry/projects/identity'

/**
 * GET /api/public/projects/{slug}/growth/
 * PP013 — melega.project-growth.v1
 */
const handler: NextApiHandler = (req, res) => {
  ...
  const body = loadProjectGrowthDocument(slug, new Date().toISOString())
  if (!body) {
    res.setHeader('Cache-Control', 'public, max-age=60')

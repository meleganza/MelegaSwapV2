 ...
 * Versioned machine-readable project document (same normalization as HTML shell).
 */
const handler: NextApiHandler = (req, res) => {
  ...
  const document = loadCanonicalProjectDocument(slug, {
  ...
  const body = toPublicProjectJson(document)

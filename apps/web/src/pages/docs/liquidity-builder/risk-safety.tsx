  ...
  <LbDocsPage
    ...
    sections={[
      ...
      },
      {
        ...
        body: (
          <p>
            Programs can be paused or stopped from the product when you need to halt further activity. Use
            pause when market conditions are uncertain or you want to review settings before continuing. Always
            confirm wallet transactions yourself.
          </p>
        ),
      },
      {

    ...
    sections={[
      {
        ...
        body: (
          <p>
            Once active, your program reviews market conditions and grows liquidity from your Token Reserve according to
            your goal and strategy. You do not manually rebalance each step — you monitor progress in the portfolio and
      ...
      },
      {
        ...
        body: (
          <p>
            Execution optimizes liquidity growth under your settings. It does not control or guarantee token price. See
            Risk &amp; Safety for more.
          </p>
        ),
        expandable: true,

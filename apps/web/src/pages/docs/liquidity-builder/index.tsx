    ...
    sections={[
      {
        ...
        body: (
          <>
            <p>
              This knowledge center explains AI Liquidity Builder in plain language so project founders can
              set up and manage liquidity programs without external support.
            </p>
            <p>
              Open a topic above, or go straight to the product to create your first program.
            </p>
          </>
        ),
      },

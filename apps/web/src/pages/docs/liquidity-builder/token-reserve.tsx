    ...
    sections={[
      {
        ...
        body: (
          <>
            ...
            <p>
              We call this Token Reserve only — not Budget, Liquidity Budget, or Capital.
            </p>
          </>
        ),
      },
      {
        ...
        body: (
          <p>
            A founder allocates <strong>1,000,000 TOKEN</strong> as Token Reserve. That reserve is used according
            to the selected strategy (Conservative, Balanced, AI Optimized, or Aggressive) and liquidity goal.
          </p>
        ),
      },
      {
        ...
        body: (
          <p>
            Reserve is deployed into liquidity according to your strategy and market conditions. Unused reserve
            stays available to the program until the strategy spends it or you pause/stop the program under the
            product rules.
          </p>
        ),
        expandable: true,

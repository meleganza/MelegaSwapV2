...
export interface CakeVaultV2Interface extends utils.Interface {
  functions: {
    ...
    "calculateHarvestDexTokenRewards()": FunctionFragment;
    "calculateTotalPendingDexTokenRewards()": FunctionFragment;
    ...
    "masterBuilder()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "calculateHarvestDexTokenRewards",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "calculateTotalPendingDexTokenRewards",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "masterBuilder",
    values?: undefined
  ): string;
...
export interface CakeVaultV2 extends BaseContract {
  ...
  functions: {
    ...
    masterBuilder(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    masterBuilder(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    masterBuilder(overrides?: CallOverrides): Promise<PopulatedTransaction>;

...
| 3 Top Farms | Rank TVL → APR → volume proxy → activity; pad to 5 from multichain farm inventory; logos + chain badge; **`useGetTopFarmsByApr` attaches `liquidity`** so Home TVL is factual |
